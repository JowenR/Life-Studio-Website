document.addEventListener('DOMContentLoaded', () => {
  ...
  ---------------------------------------- */
  const preloadImages = [
    "Wedding_pics\Wedding(1).png",
    "Wedding_pics\Wedding(2).png",
    "Wedding_pics\Wedding(3).png",
    "Wedding_pics\Wedding(4).png",
    "Wedding_pics\Wedding(5).png",
    "Wedding_pics\Wedding(6).png"
